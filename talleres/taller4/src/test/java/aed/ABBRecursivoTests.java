...
class ABBRecursivoTests {

    @Test
    void nuevo_conjunto_vacio() {
        ABBRecursivo<Integer> conjunto = new ABBRecursivo<Integer>();
    ...
    void insertar_cinco_nombres() {
        ABBRecursivo<String> conjunto = new ABBRecursivo<String>();
    ...
    void conjunto_vacio_toString() {
        ABBRecursivo<Integer> c = new ABBRecursivo<Integer>();
